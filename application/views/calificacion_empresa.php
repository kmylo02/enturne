...
<html>
    ...
    <body>
        <div>
            ...
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Estimada empresa: <?= $nombre_empresa ?><br><br></p> 
            <p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Por el siguiente contrato, el<br>
                Conductor: <?= $nombre_usuario ?><br>Placa: <?= $placa ?><br>Trayecto: <?= $trayecto ?><br>Inicio contrato: <?= $inicio ?><br>
                Final contrato: <?= $final ?><br><br>Calificó por su oferta: <?= $ranking ?><br><br>
                Observaciones: <?= $obsv ?><br><br>Nota: Enturne En Línea, es una aplicación informativa para el servicio de calificación de la oferta de carga, es responsabilidad de la empresa de transporte que lo contrato, verificar la exactitud de la información suministrada por el usuario conductor.<br><br>Equipo Enturne.<br><br>Si tiene cualquier duda, contactanos a las líneas<br>(571) 4968958 </h3> <a href="http://www.enturne.co/index.php/contactenos">http://www.enturne.co/index.php/contactenos</a><br>
