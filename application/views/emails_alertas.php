...
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">Cordial saludo,<br>El usuario: <?php echo $nombre?><br>Placa: <?php echo $placa?><br>Conductor: <?php echo $conductor?><br>Celular: <?php echo $celular?><br>Fecha y hora:  <?php echo $fecha_actual?><br>Ubicación: <?php echo $ubicacion?><br><br>
Mensaje: <?php echo $mensaje?>Equipo Enturne.<br><br>Si tiene cualquier duda, contactanos a las l’neas <br> (571) 4968958  </h3><br> <a href="http://www.logiservi.com">http://www.logiservi.com</a><br><br><h5>
<br><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 559px" src="<?php echo base_url('assets/img/firmaemail.png')?>" alt="Firma" width="559" height="165"><br>
