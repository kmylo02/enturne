...
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"><br>Estimado Usuario: <?php echo $nombre?><br>Placa-Vehiculo: <?php echo $placa?><br><br>ENTURNE EN LINEA le informa que el documento <strong><u><?= $tipo?></u></strong> de su vehiculo, le ha sido <strong>aprobado</strong> en la multiplataforma. Para poder continuar con el proceso de creación de su cuenta y habilitar todas las herramientas que le brinda Enturne En Línea, favor ingresar con su usuario y contraseña a <a href="https://app.enturne.co/">https://app.enturne.co/</a>.<br><br>Si desea soporte, favor contactarnos.<br><br>Gracias, por su valiosa colaboración prestada.<br><br>
