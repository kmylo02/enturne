...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<a href="vwFormRefEmpConductor.php"></a>
			<ol class="breadcrumb">
	...
	<form method="post" action="<?php echo base_url() . 'admin/Conductores/edit_ref_emp' ?>" id="basicBootstrapForm" class="form-horizontal">
		...
		echo $row->idReferenciaEmpresarial
		?>"/>
		...
		<div class = "form-group">
			<div class = "col-xs-9 col-xs-offset-3">
				<input type = "submit" class = "btn btn-primary" name = "update_refemp" value = "Actualizar"/>
			</div>
		</div>
	</form>
</div><!--/#page-wrapper -->
