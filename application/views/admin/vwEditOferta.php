...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				<li><a href="<?= base_url() . 'admin/Ofertas' ?>"><i class="fa fa-level-up fa-2x"></i></a></li>
	...
	<form method="post" action="javascript:updateOferta()" id="frmEditCarga" class="form-horizontal">
		...
		<div class = "form-group">
			...
			<div class = "col-xs-4">
				<input type = "text" id="fecha_cargue" readonly name = "fecha" placeholder="AAMMDD" required value="<?= $oferta->fecha ?>">
			</div>
		</div>
