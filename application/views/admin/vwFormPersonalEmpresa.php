...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1>Empresa<small>  Crear personal</small></h1>
			<ol class="breadcrumb">
	...
	echo form_open("admin/Empresas/guardar_personal", $attributes);
	?>
	<input type="hidden" name="code" value="<?php echo $code = rand(1000, 99999) ?>"/>
	<input type="hidden" name="id_emp" value="<?php echo $empresa->idEmpresa ?>"/>
	...
	<div class = "form-group">
		...
		<div class = "col-xs-4">
			...
			<input type = "text" class = "form-control" disabled="" value="Personal Empresa"/>
		</div>
	</div>
