...
<div id="page-wrapper">
    ...
    <form method="post" action="<?php echo base_url() . 'empresa/Perfil/update_vehiculo' ?>" id="basicBootstrapForm" class="form-horizontal">
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type="text" class="form-control" value="<?= $vehiculo->nombre_ciudad; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type="text" class="form-control" value="<?= $vehiculo->nombre_tv; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type="text" class="form-control" value="<?= $vehiculo->nombre_carr; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" value="<?= $vehiculo->trailer; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" value="<?= $vehiculo->trailermarca; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "satelite" value="<?= $vehiculo->satelite; ?> " disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "sateliteusuario" value="<?= $vehiculo->sateliteusuario; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "sateliteclave" value="<?= $vehiculo->sateliteclave; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "repotenciacion" value="<?= $vehiculo->repotenciacion; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "modelo" value="<?= $vehiculo->modelo; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "modelo" value="<?= $vehiculo->idMarca; ?>" disabled=""/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "text" class = "form-control" name = "capacidad_carga" value="<?= $vehiculo->capacidad_carga; ?>" onKeyPress="return validar(event)" maxlength="10"/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "date" class="form-control" readonly name = "vence_soat" value="<?= $vehiculo->vence_soat; ?>" disabled/>
            </div>
        </div>
        ...
        <div class = "form-group">
            ...
            <div class = "col-xs-4">
                <input type = "date" class="form-control" readonly name = "vence_rtecnomecanica" value="<?= $vehiculo->vence_rtecnomecanica; ?>" disabled/>
            </div>
        </div>
    ...
    <div>
        ...
        <?php if (isset($soattemp)) { ?>
            <div align="left"><img id="foto_rut" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $soattemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($rtecnotemp)) { ?>
            <div align="left"><img id="foto_rut" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $rtecnotemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($lictemp)) { ?>
            <div align="left"><img id="foto_lict" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $lictemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($cedptemp)) { ?>
            <div align="left"><img id="foto_cedp" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $cedptemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($rutptemp)) { ?>
            <div align="left"><img id="foto_rut" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $rutptemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($frontaltemp)) { ?>
            <div align="left"><img id="foto_frontal" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $frontaltemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($latdertemp)) { ?>
            <div align="left"><img id="foto_latder" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $latdertemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <?php if (isset($traseratemp)) { ?>
            <div align="left"><img id="foto_latizq" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $traseratemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="icon-file-alt"></i> Foto del Registro Nacional de Remolques</li>
                    <div style="clear: both;"></div>
                </ol>
            </div>
        </div><!-- /.row -->
        ...
        <?php if (isset($remolquetemp)) { ?>
            <div align="left"><img id="foto_remol" src="<?= base_url() ?>uploads/vehiculos/<?= $idv ?>/<?= $remolquetemp ?>" alt="Sin pendiente" width="60" height="60"/></div>
    ...
    <div><a href="<?= base_url() . 'empresa/Perfil/get_vehiculos' ?>"><i class="fa fa-angle-double-right fa-2x"></i><i class="fa fa-angle-double-right fa-2x"></i><i class="fa fa-angle-double-right fa-2x"></i></a></div>
</div><!--/#page-wrapper -->
