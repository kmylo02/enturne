...
<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px"><br>Usuario: <?php echo $conductor?><br>Conductor: <?php echo $nombre?>
                              <br>Celular: <?php echo $celular?><br><br>Trayecto: <?php echo $trayecto?><br>
                              Fecha y hora: <?php echo $fecha?><br>Ubicación: <?php echo $ubicacion?><br>
                              Reporte: <?php echo $reporte?><br><br>Nota: Enturne En Línea, es una aplicación informativa para este servicio de Reportes, es responsabilidad de la empresa de transporte que lo contrate, verificar la exactitud de la información suministrada por el usuario.<br><br>Equipo Enturne.<br><br>Si tiene cualquier duda, contactanos a las líneas <br> (571) 4968958 </h3><br> <a href="http://www.enturne.co/index.php/contactenos">http://www.enturne.co/index.php/contactenos</a><br>
