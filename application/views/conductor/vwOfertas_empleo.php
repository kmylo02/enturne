  ...
  <div class="row">
	...
	<?php if ($tipo == 3 || $tipo == 2) { ?>
		<div class="row">
			...
			<div class="col-lg-3">
				<div class="panel panel-success">
					...
					<a href="<?php echo base_url() . 'conductor/Empleo/Ofertas_Empleo' ?>">
						<div class="panel-footer">
							<center>
			...
			<div class="col-lg-3">
				<div class="panel panel-warning">
					...
					<a href="<?php echo base_url() . 'conductor/Empleo/get_all_conductores_contratados' ?>">
						<div class="panel-footer">
							<center>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h5 class="modal-title">Vacantes de Empleo para Conductores</h5>
					</div>
					<div class="modal-body">
						<form method="post" action="javascript:crearVacante()" id="addVacanteForm" class="form-horizontal">
							...
							<div class = "form-group">
								...
								<div class = "col-xs-5">
									<input type="text" class="form-control" name="fechacierre" id="fechavenlic" placeholder="AAAAMMDD" required>
								</div>
							</div>
							...
							<div class="modal-footer">
								<p style="text-align:center">Para crear su vancante de empleo, es necesario que tenga registrado los vehiculos de su propiedad ó administración.</p>
		...
		<?php } else { ?>
			...
			<!-- Modal -->
			<div class="modal fade" id="detalleVacante" role="dialog">
				<div class="modal-dialog">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">Detalle vacante</h4>
						</div>
						<div class="modal-body">
							<textarea class="form-control"><?php echo $detalle; ?></textarea>
						</div>
						<div class="modal-footer">
